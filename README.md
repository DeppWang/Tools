...
- [App Cleaner & Uninstaller](https://nektony.com/mac-app-cleaner) - 完全及安全的卸载 APP，完整功能收费，但利用软件找到隐藏大文件路径，再手动清理
...
<!--，Android 破解版 [看这里](https://pan.baidu.com/s/1bfgIySxTG6d7xkjs4oiLJw)（提取码 - um3h），-->
