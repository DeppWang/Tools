...
## Windows
* [Wox](http://wox.one)：一款针对 Windows 的效率启动器，相当于 MacOS 的 [Alfred](https://www.alfredapp.com/)。
...
* [Free Download Manager](https://chrome.google.com/webstore/detail/free-download-manager/ahmpjcflkgiildlgicmcieglgoilbfdp?utm_source=chrome-ntp-icon) ：一个免费的，支持BT磁力下载的插件，用于唤起[客户端](https://www.freedownloadmanager.org/zh/download.htm)下载。客户端支持Windows和MacOS
...
* [PicGo](https://molunerfinn.com/PicGo/)：一个图片上传和管理的图床客户端，支持MacOS、Windows、Linux
   * [github地址](https://github.com/Molunerfinn/PicGo)

## 图片素材
* [Behance](https://www.behance.net/)：一个主要是各种插画创意图片的网站
* [Pexels](https://www.pexels.com/)：一个分享免费图片和视频的网站
...
## 未分类
* [RecordScreen.io](https://recordscreen.io/)：一款只需浏览器便可一键录屏的神器
